...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'pique-polo-shirt',
    name: 'Piqué Classic Collar Polo Shirt',
    category: 'polo-shirts',
    subtitle: 'Breathable honeycomb piqué polo with 3-button placket',
    description: 'Smart casual polo shirt crafted from breathable honeycomb piqué fabric with a crisp structured collar and tailored 3-button placket. Available in an extensive range of vibrant solid colors.',
    price: 850,
    currency: 'KSh',
    image: 'polo',
    featured: true,
